...
#define VERMILION   CLITERAL(Color){227, 66, 52, 255}
...
#define SED         CLITERAL(Color){220, 51, 25, 255}
#define EINHEIT     CLITERAL(Color){253, 245, 81, 255}
#define DEMOBLUE    CLITERAL(Color){71, 81, 150, 255}
#define DEMORED     CLITERAL(Color){169, 49, 62, 255}
